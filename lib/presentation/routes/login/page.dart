...
class LoginPage extends StatefulWidget {
  ...
  /// The way out for someone who came here by choice — an anonymous session
  /// from its profile. Null as a gate (the web, a device with no session at
  /// all), where there is nowhere else to be.
    ...
    return Scaffold(
      body: SafeArea(
        child: Stack(
          children: [
            _body(context),
            if (widget.onClose case VoidCallback onClose)
              Positioned(
                top: 4,
                left: 4,
                child: IconButton(
