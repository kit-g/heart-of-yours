...
class LRu extends L {
  ...
  @override
  String get onboardingLocalTitle => 'Ваши данные остаются на устройстве';
  ...
  String get onboardingLocalTrade =>
      'Честная сделка: потеряете устройство — потеряете данные, если только не войдёте в аккаунт.';
  ...
  @override
  String get themePresetSetting => 'Тема';

  @override
  String get themePresetSettingSubtitle => 'Пресеты, подобранные для светлого и тёмного режима';

  @override
  String get themePresetForge => 'Кузница';

  @override
  String get themePresetInk => 'Чернила';
