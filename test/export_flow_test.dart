...
void main() {
  ...
  group('the page', () {
    ...
    testWidgets('says how many workouts the file holds when the server has older ones', (tester) async {
      // the first page came back with more behind it — the mirror is short
      when(
